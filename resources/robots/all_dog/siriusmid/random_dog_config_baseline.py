...
class RandomBaseCfg(LeggedRobotCfg):
    ...
    class init_state(LeggedRobotCfg.init_state):
        ...
        default_joint_angles = {  # = target angles [rad] when action = 0.0
            "rf_abad_joint": -0.05,  # [rad]
            "lf_abad_joint": -0.05,  # [rad]
            "rr_abad_joint": 0.05,  # [rad]
            "lr_abad_joint": 0.05,  # [rad]

            "rf_hip_joint": 0.8,  # [rad]
            "lf_hip_joint": 1.0,  # [rad]
            "rr_hip_joint": 0.8,  # [rad]
            "lr_hip_joint": 1.0,  # [rad]

            "rf_knee_joint": -1.5,  # [rad]
            "lf_knee_joint": -1.5,  # [rad]
            "rr_knee_joint": -1.5,  # [rad]
            "lr_knee_joint": -1.5,  # [rad]
        }
    ...
    class asset(LeggedRobotCfg.asset):
        file = '{LEGGED_GYM_ROOT_DIR}/resources/robots/all_dog/siriusmid/urdf/siriusmid.urdf'
        name = "go1"
        foot_name = "foot"
