...
class RandomBaseCfg(LeggedRobotCfg):
    ...
    class control(LeggedRobotCfg.control):
        ...
        damping = {"joint": 0.2}  # [N*m*s/rad]        # action scale: target angle = actionScale * action + defaultAngle
        action_scale = 0.25
    ...
    class asset(LeggedRobotCfg.asset):
        file = '{LEGGED_GYM_ROOT_DIR}/resources/robots/all_dog/spotmicro/urdf/spotmicro.urdf'
        name = "go1"
        foot_name = "foot"
